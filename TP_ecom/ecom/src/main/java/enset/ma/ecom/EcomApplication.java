package enset.ma.ecom;

import enset.ma.ecom.entities.Category;
import enset.ma.ecom.entities.Product;
import enset.ma.ecom.repositories.CategoryRepository;
import enset.ma.ecom.repositories.ProductRepository;
...
public class EcomApplication {
    ...
    CommandLineRunner start(ProductRepository productRepository,
        ...
        return args -> {
            Stream.of("Computers","tvs","phones").forEach(name->{
